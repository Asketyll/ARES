...
| Sheet Levels | Show every level, in every open view, of every sheet model whose name matches a pattern (default `*Folio*`) — references included | [EN](https://github.com/Asketyll/ARES/wiki/Sheet-Levels)&nbsp;·&nbsp;[FR](https://github.com/Asketyll/ARES/wiki/Niveaux-des-Modeles-Papier) |
| Custom Properties | Attach DGNLib-defined properties (Item Types) to elements automatically as they are created or modified, by rules on level, name and type | [EN](https://github.com/Asketyll/ARES/wiki/Custom-Properties)&nbsp;·&nbsp;[FR](https://github.com/Asketyll/ARES/wiki/Proprietes-Personnalisees) |
