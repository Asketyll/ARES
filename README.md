...
| Sheet Levels | Turn on the display of every level in every sheet model whose name matches a pattern (default `*Folio*`) | [EN](https://github.com/Asketyll/ARES/wiki/Sheet-Levels)&nbsp;·&nbsp;[FR](https://github.com/Asketyll/ARES/wiki/Niveaux-des-Modeles-Papier) |
