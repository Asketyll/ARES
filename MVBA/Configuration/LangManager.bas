...
Sub InitializeTranslations()
    ...
    moTranslations.Add "EN_CalculationMultiplePropCandidates", "ARES: Property calculation - several linked elements in this group carry the source property; the first one found sets the value"
    ...
    moTranslations.Add "FR_CalculationMultiplePropCandidates", "ARES : Calcul de propriété - plusieurs éléments liés dans ce groupe portent la propriété source ; le premier trouvé impose la valeur"
