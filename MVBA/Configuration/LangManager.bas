...
Sub InitializeTranslations()
    ...
    ' --- Property Propagation options GUI + statuses ---
    moTranslations.Add "EN_PropagationGUIOptionsCaption", "Property Propagation options"
    moTranslations.Add "EN_PropagationGUIOptionsMain_LabelCaption", "Propagate a label cell's text to its group"
    moTranslations.Add "EN_PropagationGUIOptionsMain_LabelTip", "When on, a trigger label cell's full text is written as the chosen custom property onto every other element of its graphic group."
    moTranslations.Add "EN_PropagationGUIOptionsCells_LabelCaption", "Trigger cell names:"
    moTranslations.Add "EN_PropagationGUIOptionsCells_LabelTip", "Cell names that trigger propagation (pipe-separated |). Example: ETI076|ETI01E"
    moTranslations.Add "EN_PropagationGUIOptionsProperty_LabelCaption", "Target property:"
    moTranslations.Add "EN_PropagationGUIOptionsProperty_LabelTip", "Custom property that receives the cell's text (must be a member of the custom-property list)."
    moTranslations.Add "EN_PropagationPropertyInvalid", "ARES: Property propagation - target property invalid (not in the custom-property list)"
    moTranslations.Add "EN_PropagationValueRejected", "ARES: Property propagation - value rejected by the target property"
    moTranslations.Add "EN_PropagationAttachFailed", "ARES: Property propagation - could not attach the property (ARES item-type library not found?)"
    moTranslations.Add "EN_PropagationMultipleTriggers", "ARES: Property propagation - several trigger cells in this group; the last-modified one sets the value"
    ' Tooltips - Zoning
    ...
    ' --- Property Propagation options GUI + statuses ---
    moTranslations.Add "FR_PropagationGUIOptionsCaption", "Options de propagation de propriété"
    moTranslations.Add "FR_PropagationGUIOptionsMain_LabelCaption", "Propager le texte d'une cellule étiquette à son groupe"
    moTranslations.Add "FR_PropagationGUIOptionsMain_LabelTip", "Si activé, tout le texte d'une cellule étiquette déclencheuse est écrit comme propriété personnalisée choisie sur chaque autre élément de son groupe graphique."
    moTranslations.Add "FR_PropagationGUIOptionsCells_LabelCaption", "Noms des cellules déclencheuses :"
    moTranslations.Add "FR_PropagationGUIOptionsCells_LabelTip", "Noms de cellules qui déclenchent la propagation (séparés par |). Exemple : ETI076|ETI01E"
    moTranslations.Add "FR_PropagationGUIOptionsProperty_LabelCaption", "Propriété cible :"
    moTranslations.Add "FR_PropagationGUIOptionsProperty_LabelTip", "Propriété personnalisée qui reçoit le texte de la cellule (doit être membre de la liste des propriétés)."
    moTranslations.Add "FR_PropagationPropertyInvalid", "ARES : Propagation de propriété - propriété cible invalide (absente de la liste)"
    moTranslations.Add "FR_PropagationValueRejected", "ARES : Propagation de propriété - valeur refusée par la propriété cible"
    moTranslations.Add "FR_PropagationAttachFailed", "ARES : Propagation de propriété - impossible d'attacher la propriété (bibliothèque d'ItemTypes ARES introuvable ?)"
    moTranslations.Add "FR_PropagationMultipleTriggers", "ARES : Propagation de propriété - plusieurs cellules déclencheuses dans ce groupe ; la dernière modifiée impose la valeur"
    ' Tooltips - Zoning
