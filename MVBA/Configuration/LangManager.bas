...
Sub InitializeTranslations()
    ...
    moTranslations.Add "EN_AutoLengthsGUIOptionsMain_LabelCaption", "Enable auto lenght"
    moTranslations.Add "EN_AutoLengthsGUIOptionsColor_LabelCaption", "Update color."
    moTranslations.Add "EN_AutoLengthsGUIOptionsOnly_Color_LabelCaption", "Update color without lenght."
    ...
    moTranslations.Add "EN_AutoLengthsGUIOptionsEdit_Triggers_List_Error", "All your triggers should include: "
    ...
    moTranslations.Add "FR_AutoLengthsGUIOptionsEdit_Triggers_List_Error", "Tout vos déclencheurs doivent comporter: "
