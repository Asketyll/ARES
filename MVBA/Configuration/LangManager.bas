...
Sub InitializeTranslations()
    ...
    moTranslations.Add "EN_CableReportComplete", "ARES: Cable report complete — {0} cable(s), {1} soil-type column(s), {2} incomplete"
    ...
    moTranslations.Add "FR_CableReportComplete", "ARES : Rapport de câbles terminé — {0} câble(s), {1} colonne(s) de nature de sol, {2} incomplet(s)"
