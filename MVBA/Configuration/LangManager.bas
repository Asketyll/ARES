...
Sub InitializeTranslations()
    ...
    mTranslations.Add "EN_RegionSplitSelectRegionC", "Split region"
    mTranslations.Add "EN_RegionSplitSelectRegionP", "Click on the edge of a closed region to split it"
    mTranslations.Add "EN_RegionSplitNoRegion", "No valid region selected"
    mTranslations.Add "EN_RegionSplitClickNotOnEdge", "Click is not on the region edge"
    mTranslations.Add "EN_RegionSplitCannotSplit", "Cannot split this region here"
    ...
    mTranslations.Add "EN_ZoningGUIOptionsCaption", "Edit zoning options:"
    mTranslations.Add "EN_ZoningGUIOptionsEditLevels_CommandCaption", "Edit source levels"
    mTranslations.Add "EN_ZoningGUIOptionsDistance_LabelCaption", "Distance:"
    mTranslations.Add "EN_ZoningGUIOptionsEditOutputLevel_CommandCaption", "Edit output level ({0})"
    mTranslations.Add "EN_ZoningGUIOptionsOutputStyle_LabelCaption", "Output style:"
    mTranslations.Add "EN_ZoningGUIOptionsEditColor_CommandCaption", "Edit Color"
    mTranslations.Add "EN_ZoningGUIOptionsWeight_LabelCaption", "Weight:"
    mTranslations.Add "EN_ZoningGUIOptionsDistanceError", "Distance must be a positive number."
    mTranslations.Add "EN_ZoningNoBufferCreated", "No buffer could be created for any of the {0} element(s) found."
    mTranslations.Add "EN_ZoningSomeBuffersFailed", "{0} of {1} element(s) could not be buffered and were skipped."
    mTranslations.Add "EN_ZoneExportGUIOptionsCaption", "Edit zone export options:"
    mTranslations.Add "EN_ZoneExportGUIOptionsEdit_Level_Region_CommandCaption", "Edit zone level"
    mTranslations.Add "EN_ZoneExportGUIOptionsRound_LabelCaption", "Decimal places:"
    mTranslations.Add "EN_ZoneExportGUIOptionsUse_Dialog_LabelCaption", "Prompt save location"
    ...
    mTranslations.Add "FR_RegionSplitSelectRegionC", "Diviser une région"
    mTranslations.Add "FR_RegionSplitSelectRegionP", "Cliquer sur le bord d'une région fermée pour la diviser"
    mTranslations.Add "FR_RegionSplitNoRegion", "Aucune région valide sélectionnée"
    mTranslations.Add "FR_RegionSplitClickNotOnEdge", "Le clic n'est pas sur le bord de la région"
    mTranslations.Add "FR_RegionSplitCannotSplit", "Impossible de diviser cette région ici"
    ...
    mTranslations.Add "FR_ZoningGUIOptionsCaption", "Modifier les options de zonage :"
    mTranslations.Add "FR_ZoningGUIOptionsEditLevels_CommandCaption", "Modifier les niveaux sources"
    mTranslations.Add "FR_ZoningGUIOptionsDistance_LabelCaption", "Distance :"
    mTranslations.Add "FR_ZoningGUIOptionsEditOutputLevel_CommandCaption", "Modifier le niveau de sortie ({0})"
    mTranslations.Add "FR_ZoningGUIOptionsOutputStyle_LabelCaption", "Style :"
    mTranslations.Add "FR_ZoningGUIOptionsEditColor_CommandCaption", "Modifier la couleur"
    mTranslations.Add "FR_ZoningGUIOptionsWeight_LabelCaption", "Épaisseur :"
    mTranslations.Add "FR_ZoningGUIOptionsDistanceError", "La distance doit être un nombre positif."
    mTranslations.Add "FR_ZoningNoBufferCreated", "Aucun buffer n'a pu être créé pour les {0} élément(s) trouvé(s)."
    mTranslations.Add "FR_ZoningSomeBuffersFailed", "{0} des {1} élément(s) n'ont pas pu être bufférisés et ont été ignorés."
    mTranslations.Add "FR_ZoneExportGUIOptionsCaption", "Modifier les options d'export de zone :"
    mTranslations.Add "FR_ZoneExportGUIOptionsEdit_Level_Region_CommandCaption", "Modifier le niveau de zone"
    mTranslations.Add "FR_ZoneExportGUIOptionsRound_LabelCaption", "Décimales :"
    mTranslations.Add "FR_ZoneExportGUIOptionsUse_Dialog_LabelCaption", "Demander l'emplacement d'export"
